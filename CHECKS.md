...
- At the bottom of the page, confirm Salary Showdown shows two distinct random combinations without medians. Select one, confirm both medians reveal, the correct/wrong styling appears, and the score updates with correct answers, rounds, and rounded percentage. After 20 rounds, confirm the final score remains visible, the cards are locked, the next-round button is hidden, and no 21st round starts.
