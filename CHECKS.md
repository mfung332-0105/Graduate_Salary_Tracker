...
- At the bottom of the page, confirm Salary Showdown shows two distinct random combinations without medians. Select one, confirm both medians reveal, the correct/wrong styling appears, and the score updates. Use **Next round** and confirm a fresh pair appears while the score remains for the session.
